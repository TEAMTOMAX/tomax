...
if NumLoop < 1 or NumLoop > 200 then 
return "☑┇ حدود التكرار ,  يجب ان تكون ما بين  *[2-200]*" 
end
...
return '🛡┊ اصدار سورس توماكس : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "👨🏻‍💻*┇* لـلـمـطـور الاسـاسـي فـقـط" end
local GetVerison = https.request('https://github.com/tomax/brothers.github.io/GetVersion.txt') or 0
...
send_key(msg.sender_user_id_,'  [⚜┇قناة سورس : الاخوين](t.me/team_tomax)',nil,inline,msg.id_)
return false
end
...
return [[
📡┇اهلا بك في سورس اتوماكس 

📯┇TOMAX TEAM

🔎┇[قناه السورس](t.me/TOMAX) 

👮‍♂️┇[مطور السورس الاول](t.me/sajad14p)

👮‍♂️┇[مطور السورس الثاني](t.me/vvvvpv)

🔋┇[كليشه التنصيب](https://t.me/team_tomax/273) 
...
🖲┊ [اضغط هنا دخول لقناة سورس ](t.me/team_tomax) •
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
💌┊لتفعيل البوت راسلني 
👮┊مـعـرف الـمـطـور  : ]]..SUDO_USER..[[
]]
...
🏷┊آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📌┊مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
🖲┊ [اضغط هنا دخول لقتاة سورس ](t.me/team_tomax) •
👮┊مـعـرف الـمـطـور  : ]]..SUDO_USER:gsub([[\_]],'_')..[[ 🌿
]])
return false
end 
